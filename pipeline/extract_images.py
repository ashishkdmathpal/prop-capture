...
def _call_groq_extract_image(
    ...
    try:
        ...
        # Normalize image_type — use what Groq returned, fall back to what we sent
...
def extract_image_labels(
    ...
    for i, page_info in enumerate(confirmed_pages):
        ...
        # Extract labels from Groq
        try:
            extracted = _call_groq_extract_image(
                client, img_bytes,
